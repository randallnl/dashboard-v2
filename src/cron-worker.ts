	...
	try {
		...
		console.log(
			JSON.stringify({
				...
				memberOnboardingQueued: members.onboarding.queued,
				memberOnboardingCompleted: members.onboarding.completed,
				memberOnboardingFailed: members.onboarding.failed,
